...
/*   Updated: 2018/05/18 13:30:48 by msukhare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_check_in_tab_player(int place, t_env *env)
{
	int		i;
...
static int	ft_check_champs_before(t_env *env, char *str)
{
	int		i;
...
static int	ft_check_fd_before(t_env *env, int i)
{
	int		j;
